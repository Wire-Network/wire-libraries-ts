...
const [packageManifest, ethereumManifest, solanaManifest] = await Promise.all([
...
const ethereumInputs = await Promise.all(
...
const rawIdl = JSON.parse(rawIdlSource.toString("utf8")),
